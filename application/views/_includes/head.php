...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/app-assets/images/favicon/apple-touch-icon-152x152.png') ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/app-assets/images/favicon/favicon-32x32.png') ?>">
