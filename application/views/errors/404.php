...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/app-assets/css/pages/page-404.css") ?>">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
                ...
                <div class="section section-404 p-0 m-0 height-100vh">
                    <div class="row">
                        ...
                        <div class="col s12 center-align white">
                            <img src="<?php echo base_url("assets/app-assets/images/gallery/error-2.png")?>" class="bg-image-404" alt="">
                            <h1 class="error-code m-0">404</h1>
                            <h6 class="mb-2">Ups! Sepertinya Anda tersesat.</h6>
                            <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="<?php echo base_url() ?>">
                                Bawa saya kembali ke Beranda.</a>
                        </div>
                    </div>
                </div>
            </div>
