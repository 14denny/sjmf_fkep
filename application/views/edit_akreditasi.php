										...
										<div class="row div-input-akreditasi col s12">
											...
											<div class="input-field col s3">
												<select name="akreditasi[]">
													<option value="1" <?php echo $data->id_nilai == 1 ? "selected" : "" ?>>A</option>
													<option value="2" <?php echo $data->id_nilai == 2 ? "selected" : "" ?>>B</option>
													<option value="3" <?php echo $data->id_nilai == 3 ? "selected" : "" ?>>C</option>
													<option value="4" <?php echo $data->id_nilai == 4 ? "selected" : "" ?>>D</option>
													<option value="5" <?php echo $data->id_nilai == 5 ? "selected" : "" ?>>Tidak Ada</option>
												</select>
